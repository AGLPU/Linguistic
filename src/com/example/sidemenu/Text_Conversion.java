...
public class Text_Conversion extends SherlockActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getSupportActionBar().setBackgroundDrawable(
				new ColorDrawable(Color.parseColor("#00497F")));
		 ...
		 * method stub /*TranslatorTask task = new
		 * TranslatorTask(Text_Conversion.this); if( mTts != null) mTts.stop();
		 * mTts.shutdown(); //task.execute(my_text.getText().toString()); Intent
		 * i=new Intent(Text_Conversion.this,Converted_Text.class);
		 * i.putExtra("from_lang",from_lang); i.putExtra("to_lang",to_lang);
		 * i.putExtra("from",fromCode); i.putExtra("to",toCode);
		 * System.out.println(my_text.getText());
		 * Converted_Text.result=my_text.getText().toString();
		 * //i.putExtra("result", my_text.getText()); startActivity(i);
				...
				.setPositiveButton("Exit",
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
									int which) {
								// TODO Auto-generated method stub
								Intent i = new Intent(Text_Conversion.this,
										MainActivity.class);
								startActivity(i);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (item.getItemId() == R.id.menu_load) {
			// startActivity(new
			// Intent(Text_Conversion.this,MainActivity.class));
